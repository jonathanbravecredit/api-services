...
import * as schemaFulfillWorker from './schema_fulfill-worker-request.json';
...
ajv.addSchema(schemaFulfillWorker, 'fulfillWorker');
ajv.addSchema(schemaNavBarRequest, 'navBarRequest');

...
import { BorrowerAddress } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/BorrowerAddress';
import { BorrowerBirth } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/BorrowerBirth';
import { BorrowerBureauIdentifier } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/BorrowerBureauIdentifier';
import { BorrowerName } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/BorrowerName';
import { BorrowerTelephone } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/BorrowerTelephone';
import { CreditScore } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/CreditScore';
import { CreditStatement } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/CreditStatement';
import { Employer } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/Employer';
import { SocialPartition } from 'lib/models/MergeReport/MergeReportComponents/BorrowerComponents/SocialPartition';
